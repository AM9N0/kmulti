...
def approval():
    ...
    os.system('clear')
    print(logo)
    print('\x1b[1;37m [\x1b[36mÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢\x1b[1;37m] You Need Approval To Use This Tool   \x1b[1;37m')
    print('\x1b[1;37m [\x1b[36mÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢\x1b[1;37m] Your Key :\x1b[36m ' + id)
    time.sleep(0.1)
    print('\x1b[1;37m----------------------------------------------')
    try:
        httpCaht = requests.get('https://github.com/AM9N0/appro/blob/main/newmulti.py').text
        if id in httpCaht:
            ...
            (os.system('am start https://wa.me/+918700850020?text=' + tks), approval())
            time.sleep(1)
            exit()
